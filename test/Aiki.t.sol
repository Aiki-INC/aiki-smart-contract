...
contract AikiTest is Test {
    ...
    function testCreateCourse() public {
        ...
        vm.prank(instructor);
        uint256 newCourseId = platform.createCourse(
            title,
            description,
            price,
            duration,
    ...
    function testEnrollInCourse() public {
        ...
        (
            uint256 enrolledCourseId,
            address enrolledStudent,
            ,
            ,
            bool isCompleted,
            uint256 progress
    ...
    function testEnrollWithRefund() public {
        ...
        vm.prank(student);
        platform.enrollInCourse{
            value: COURSE_PRICE + PLATFORM_FEE + overpayment
        }(courseId);
    ...
    function testIssueCertificate() public {
        ...
        address recipient,
        ,
        string memory certURI) = platform.certificates(1);
    ...
    function testGetStudentEnrollments() public {
        ...
        vm.prank(student);
        platform.enrollInCourse{value: COURSE_PRICE + PLATFORM_FEE}(
            secondCourseId
        );
